...
@implementation DeMarcelpociotSmpagecontrolScrollableViewProxy
...
-(void)_initWithProperties:(NSDictionary *)properties
{
    ...
    [self initializeProperty:@"pagingControlMargin" defaultValue:NUMFLOAT(20.0)];
    [self initializeProperty:@"pagingControlDiameter" defaultValue:NUMFLOAT(10.0)];
    [self initializeProperty:@"pagingControlAlignment" defaultValue:NUMINT(0)];
...
-(UIView *)parentViewForChild:(TiViewProxy *)child
{
	...
	if (index != NSNotFound)
	{
		DeMarcelpociotSmpagecontrolScrollableView * ourView = (DeMarcelpociotSmpagecontrolScrollableView *)[self view];
...
- (void)willAnimateRotationToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation duration:(NSTimeInterval)duration
{
    if ([self viewAttached]) {
        [(DeMarcelpociotSmpagecontrolScrollableView*)[self view] manageRotation];
    }
}
